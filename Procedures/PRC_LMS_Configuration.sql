--EXEC PRC_LMS_Configuration @Action='GlobalCheck',@UserID=11738

IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[PRC_LMS_Configuration]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [PRC_LMS_Configuration] AS' 
END
GO

ALTER PROCEDURE [dbo].[PRC_LMS_Configuration]
(
