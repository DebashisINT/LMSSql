...
Written by Sanchita on 21-06-2024 for V2.0.47	LMS- Content Master implementation
												Refer: 27552
Rev 1.0		Sanchita	v1.0.1		07/02/2025		Content duration to save from Portal.
****************************************************************************************************************************************************************************/
BEGIN
	SET NOCOUNT ON
		...
		BEGIN TRANSACTION
			...
			BEGIN
				...
				BEGIN
					...
					-- Rev 1.0 [FLOOR(@CONTENT_FILEDURATION) updated]
					INSERT INTO LMS_CONTENT (CONTENTID, CONTENTTITLE, CONTENTDESC, CONTENT_PLAYSEQ, CONTENTSTATUS, CONTENT_TOPICID,
						...
						@CONTENT_FILENAME, @CONTENT_FILESIZE, @CONTENT_FILEPATH, @CONTENT_FILETYPE,@CONTENT_ICONFILEPATH , FLOOR(@CONTENT_FILEDURATION),
				...
				BEGIN
					...
					BEGIN
						...
						UPDATE LMS_CONTENT SET CONTENTTITLE=@CONTENTTITLE, CONTENTDESC=@CONTENTDESC, CONTENT_PLAYSEQ=@PLAYSEQUENCE, CONTENTSTATUS=@STATUS, CONTENT_TOPICID=@TOPICID, 
							...
							CONTENT_FILETYPE=@CONTENT_FILETYPE, CONTENT_FILEDURATION=floor(@CONTENT_FILEDURATION),
