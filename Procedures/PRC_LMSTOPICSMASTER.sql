...
Written by Sanchita on 21-06-2024 for V2.0.47	LMS Topic Master Module Implementation. 
												Refer: 27539
Rev 1.0		Sanchita	V2.0.49		08/10/2024		27757: Changes in Topic master of LMS

Rev 2.0		Sanchita	V1.0.1		05/02/2025	Define the topic assignment date and end date. Mantis :
****************************************************************************************************************************************************************************/
BEGIN
	SET NOCOUNT ON
	...
	-- Rev 2.0
	DECLARE @TOPIC_ENDDATE DATETIME = NULL
	-- End of Rev 2.0
			...
			BEGIN
				...
				BEGIN TRANSACTION
					...
					begin
						...
						IF(@TOPIC_COMP_DAY>0)
						BEGIN
							SET @TOPIC_ENDDATE = DATEADD(DAY,@TOPIC_COMP_DAY,SYSDATETIME())
						END
						-- End of Rev 2.0
						...
						BEGIN
							...
							BEGIN
								...
								-- Rev 2.0 [ new column TOPIC_CATEGORYID added]
								INSERT INTO LMS_TOPICS (TOPICID, TOPICNAME, TOPICBASEDON_ID, TOPICSTATUS, CREATEDBY, CREATEDON, TOPIC_COMP_DAY, TOPIC_ISDEFAULT, TOPIC_SEQ, TOPIC_CATEGORYID)
								VALUES (@TOPICID_AUTO, @TOPICNAME, @TOPICBASEDON_ID, @TOPICSTATUS, @USERID, SYSDATETIME(), @TOPIC_COMP_DAY, @TOPIC_ISDEFAULT, @TOPIC_SEQ, @CATEGORY_ID )
							...
							-- Rev 2.0 [ new column TOPIC_ENDDATE added]
							INSERT INTO LMS_TOPIC_BRANCHMAP (TOPIC_BRANCHMAPID, TOPICID, TOPIC_BRANCHID, CREATEDBY,	CREATEDON, TOPIC_ENDDATE)
							VALUES (@TOPICMAPID_AUTO, @TOPICID_AUTO, @ID, @USERID, SYSDATETIME(), @TOPIC_ENDDATE )
						...
						BEGIN
							...
							-- Rev 2.0 [ new column TOPIC_ENDDATE added]
							INSERT INTO LMS_TOPIC_DESIGMAP (TOPIC_DESIGMAPID, TOPICID, TOPIC_DESIGID, CREATEDBY,	CREATEDON, TOPIC_ENDDATE)
							VALUES (@TOPICMAPID_AUTO, @TOPICID_AUTO, @ID, @USERID, SYSDATETIME(), @TOPIC_ENDDATE )
						...
						BEGIN
							...
							-- Rev 2.0 [ new column TOPIC_ENDDATE added]
							INSERT INTO LMS_TOPIC_DEPTMAP (TOPIC_DEPTMAPID, TOPICID, TOPIC_DEPTID, CREATEDBY,	CREATEDON, TOPIC_ENDDATE)
							VALUES (@TOPICMAPID_AUTO, @TOPICID_AUTO, @ID, @USERID, SYSDATETIME(), @TOPIC_ENDDATE )
						...
						BEGIN
							...
							-- Rev 2.0 [ new column TOPIC_ENDDATE added]
							INSERT INTO LMS_TOPIC_EMPMAP (TOPIC_EMPMAPID, TOPICID, TOPIC_EMPID, TOPIC_EMPCNTID, TOPIC_USERID, CREATEDBY,	CREATEDON, TOPIC_ENDDATE)
							VALUES (@TOPICMAPID_AUTO, @TOPICID_AUTO, @ID, @CNT_CONTACTID, @CNT_USERID, @USERID, SYSDATETIME(), @TOPIC_ENDDATE )
	...
	BEGIN
		...
		BEGIN
			...
			SELECT T.TOPICNAME, convert(nvarchar(10),T.TOPICBASEDON_ID) TOPICBASEDON_ID, TOPICSTATUS,
				...
				'Branches' as tabNameText, 'Selected branches' as rightTabNameText, 'search in branches' as searchPlaceholderText 
				-- Rev 2.0
				, convert(nvarchar(10),ISNULL(TOPIC_CATEGORYID,0)) TOPIC_CATEGORYID
				-- End of Rev 2.0
		...
		BEGIN
			...
			-- Rev 2.0
			SET @StrSql += '	, convert(nvarchar(10),ISNULL(TOPIC_CATEGORYID,0)) TOPIC_CATEGORYID '
				-- End of Rev 2.0
					...
					begin
						...
						BEGIN
							...
							BEGIN
								...
								UPDATEDON=GETDATE(), TOPIC_SEQ=@TOPIC_SEQ, TOPIC_CATEGORYID=@CATEGORY_ID WHERE TOPICID=@TOPICID
								...
								BEGIN
									INSERT INTO #tempMapTable (ID, TOPICID, CREATEDBY, CREATEDON, TOPIC_ENDDATE)
										SELECT TOPIC_BRANCHID, TOPICID, CREATEDBY, CREATEDON, TOPIC_ENDDATE FROM LMS_TOPIC_BRANCHMAP WHERE TOPICID=@TOPICID
								...
								BEGIN
									INSERT INTO #tempMapTable (ID, TOPICID, CREATEDBY, CREATEDON, TOPIC_ENDDATE)
										SELECT TOPIC_DESIGID, TOPICID, CREATEDBY, CREATEDON, TOPIC_ENDDATE FROM LMS_TOPIC_DESIGMAP WHERE TOPICID=@TOPICID
								...
								BEGIN
									INSERT INTO #tempMapTable (ID, TOPICID, CREATEDBY, CREATEDON, TOPIC_ENDDATE)
										SELECT TOPIC_DEPTID, TOPICID, CREATEDBY, CREATEDON, TOPIC_ENDDATE FROM LMS_TOPIC_DEPTMAP WHERE TOPICID=@TOPICID
								...
								BEGIN
									INSERT INTO #tempMapTable (ID, TOPICID, CREATEDBY, CREATEDON, TOPIC_ENDDATE)
										SELECT TOPIC_EMPID, TOPICID, CREATEDBY, CREATEDON, TOPIC_ENDDATE FROM LMS_TOPIC_EMPMAP WHERE TOPICID=@TOPICID
							...
							-- Rev 2.0 [New column TOPIC_ENDDATE added]
							INSERT INTO LMS_TOPIC_BRANCHMAP (TOPIC_BRANCHMAPID, TOPICID, TOPIC_BRANCHID, CREATEDBY,	CREATEDON, TOPIC_ENDDATE)
							VALUES (@TOPICMAPID_AUTO, @TOPICID, @ID, @USERID, SYSDATETIME(), @TOPIC_ENDDATE )

							IF (@TOPICBASEDON = @TOPICBASEDON_OLD)
							BEGIN
								-- Rev 2.0 [ new column TOPIC_ENDDATE added]
								UPDATE MAP SET CREATEDBY=TEMP.CREATEDBY, CREATEDON=TEMP.CREATEDON, TOPIC_ENDDATE=TEMP.TOPIC_ENDDATE 
						...
						BEGIN
							...
							-- Rev 2.0 [ new column TOPIC_ENDDATE added]
							INSERT INTO LMS_TOPIC_EMPMAP (TOPIC_EMPMAPID, TOPICID, TOPIC_EMPID, TOPIC_EMPCNTID, TOPIC_USERID, CREATEDBY,	CREATEDON, TOPIC_ENDDATE)
							VALUES (@TOPICMAPID_AUTO, @TOPICID, @ID, @CNT_CONTACTID, @CNT_USERID, @USERID, SYSDATETIME(), @TOPIC_ENDDATE )

							IF (@TOPICBASEDON = @TOPICBASEDON_OLD)
							BEGIN
								-- New column TOPIC_ENDDATE added
								UPDATE MAP SET CREATEDBY=TEMP.CREATEDBY, CREATEDON=TEMP.CREATEDON, TOPIC_ENDDATE=TEMP.TOPIC_ENDDATE  
