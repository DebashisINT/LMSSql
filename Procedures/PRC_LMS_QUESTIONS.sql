...
@DESCRIPTION3 VARCHAR(500)=NULL,
@DESCRIPTION4 VARCHAR(500)=NULL
--REV 1.0 END
)
AS
/*************************************************************************************************************************
...
REV 1.0   05-02-2025  Priti      Add a "Fact" field for quiz questions, which will be displayed when the user selects the correct answer.
******************************************************************************************************************************/
BEGIN
	SET NOCOUNT ON
	...
	BEGIN
		...
		BEGIN			
			...
			--REV 1.0
			,OPTIONS_DESCRIPTION1,OPTIONS_DESCRIPTION2,OPTIONS_DESCRIPTION3,OPTIONS_DESCRIPTION4
			--REV 1.0 END
			)
			...
			-- Rev Sanchita
			IF(@MODE = 'AddOnFly' OR @MODE = 'AddOnFlySave')
			BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			(
				...
				QUESTIONS_DESCRIPTN NVARCHAR(500),
				CNTTOPIC bigint,
				CNTCATEGORY bigint,
				CREATEDATE datetime,
